...
const Sidebar = () => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`z-9999 w-72.5 fixed left-0 top-0 flex h-screen flex-col overflow-y-hidden bg-black duration-300 ease-linear lg:translate-x-0 dark:bg-gray-800 ${
